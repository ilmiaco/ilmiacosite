...
export default function HeroSection({ medicalProductUrl }: HeroSectionProps) {
  return (
    <section
      className="relative md:min-h-[100svh] flex items-center overflow-hidden"
      ...
      <div className="relative z-10 w-full">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 pt-28 pb-14 sm:pt-32 md:pt-40 md:pb-20">
          <div className="max-w-3xl">
            ...
            {/* Tagline badge */}
            <div className="mb-5 sm:mb-9 inline-block bg-[#3D2C1E]/4 border-l-[3px] sm:border-l-2 border-[#D98324] pl-5 pr-4 py-3 sm:py-2.5">
              <p className="text-sm sm:text-base text-[#2C3E40]/80 leading-relaxed tracking-wide">
            ...
            {/* Hero heading — Mincho serif treatment */}
            <h1
              id="hero-heading"
              className="text-[2.125rem] sm:text-4xl md:text-5xl lg:text-[4rem] font-bold mb-6 sm:mb-10 leading-[1.2] tracking-tight"
              itemProp="headline"
            >
            ...
            <p className="text-sm sm:text-lg md:text-xl text-[#6B7273] mb-7 sm:mb-12 leading-[1.9] sm:leading-[2] max-w-2xl">
            ...
            <ul className="flex flex-col sm:flex-row sm:flex-wrap gap-y-2.5 sm:gap-x-8 text-sm text-[#6B7273]">
